...
class ImageTransTextUpWidget extends StatelessWidget {
  ...
  ImageTransTextUpWidget(this._eventsObject, {this.onFormatSelected, this.deleteItemFunc, this.isFromNetwork=false});
